    ...
    <>
      <section className="bg-dark-bg py-16">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <span className="inline-block bg-primary-orange/20 text-primary-gold text-sm font-semibold px-4 py-1 rounded-full mb-6">
            Em Breve
          </span>
      ...
      <section className="py-20 bg-surface">
        <div className="max-w-lg mx-auto px-4 text-center">
          <div className="bg-white rounded-xl p-8 shadow-sm">
            ...
            {submitted ? (
              <>
                <h2 className="text-2xl font-bold text-dark mb-3">Obrigado!</h2>
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
                  <input
                    ...
                    required
                    className="flex-1 border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-primary-orange focus:border-transparent outline-none transition-all"
                  />
