  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {[
          { label: "Pendentes", value: stats.pending, color: "bg-yellow-500", textColor: "text-yellow-600" },
          { label: "Confirmados", value: stats.confirmed, color: "bg-blue-500", textColor: "text-blue-600" },
          { label: "Em Atendimento", value: stats.in_progress, color: "bg-orange-500", textColor: "text-orange-600" },
          { label: "Concluídos", value: stats.done, color: "bg-green-500", textColor: "text-green-600" },
        ].map((stat) => (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl p-6 shadow-sm">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-2xl font-bold text-dark">{stats.today}</span>
          </div>
          <div className="mt-4">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-2xl font-bold text-dark">{stats.this_week}</span>
          </div>
          <div className="mt-4">
            <Link href="/admin/agendamentos" className="text-primary-orange text-sm font-medium hover:underline">
              Ver todos os agendamentos →
