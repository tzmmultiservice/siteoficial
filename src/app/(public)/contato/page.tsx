...
export const metadata: Metadata = {
  ...
  description: "Entre em contato com a TZM Multi Service. WhatsApp, telefone, email e endereço.",
};
    ...
    <>
      <section className="pt-32 pb-16 relative">
        ...
        <div className="relative max-w-3xl mx-auto px-4 text-center">
          <p className="text-primary-orange text-sm font-semibold tracking-widest uppercase mb-3">Fale conosco</p>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-4">
            Fale <span className="gradient-text">Conosco</span>
          </h1>
          <p className="text-gray-500 text-lg">
            Estamos prontos para atender você. Entre em contato pelo WhatsApp ou visite nossa oficina.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="glass-card rounded-2xl p-8">
                ...
                <div className="space-y-4">
                  ...
                  <a
                    ...
                    className="flex items-center gap-4 p-4 rounded-xl bg-green-500/5 border border-green-500/10 hover:border-green-500/30 hover:bg-green-500/10 transition-all duration-300 group"
                  >
                    ...
                    <div>
                      ...
                      <p className="text-green-400 font-medium">{COMPANY.phone}</p>
                    </div>
                  ...
                  {/* Telefone */}
                  <a href={`tel:${COMPANY.phone}`} className="flex items-center gap-4 p-4 rounded-xl hover:bg-white/[0.02] transition-all duration-300 border border-transparent hover:border-dark-border-light">
                  ...
                  {/* Email */}
                  <a href={`mailto:${COMPANY.email}`} className="flex items-center gap-4 p-4 rounded-xl hover:bg-white/[0.02] transition-all duration-300 border border-transparent hover:border-dark-border-light">
                    <div className="w-12 h-12 rounded-xl gradient-brand flex items-center justify-center text-white shrink-0">
                      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Horários */}
              <div className="glass-card rounded-2xl p-8">
                <h3 className="font-bold text-xl text-white mb-5">Horário de Funcionamento</h3>
                <div className="space-y-3">
                  <div className="flex justify-between py-3 border-b border-dark-border">
                    <span className="text-gray-500">Segunda a Sexta</span>
                    <span className="font-semibold text-white">8h às 18h</span>
                  </div>
                  <div className="flex justify-between py-3 border-b border-dark-border">
                    <span className="text-gray-500">Sábado</span>
                    <span className="font-semibold text-white">8h às 12h</span>
                  </div>
            ...
            {/* Mapa */}
            <div className="rounded-2xl overflow-hidden ring-1 ring-white/5 h-[500px] lg:h-full lg:min-h-[600px]">
              <iframe
